export default function About() {
  return (
    <div className="bg-[#DBAA78] p-10 rounded-xl sticky top-0 z-20 text-[17px]">
      ...
      <p className="mb-4">
        Na een loopbaan van bijna 25 jaar in de financiële dienstverlening
        was het tijd voor wat anders. Ik startte mijn eigen praktijk als voedingscoach. 
        Met behulp van WordPress maakte ik de website voor mijn praktijk SMART Voedingsadvies.
        Dit wekte een nieuwe interesse tot leven. Voor ik het wist had ik de opleiding 
        Front-End Development geboekt bij Winc Academy.
      </p>
      <p className="mb-4">
      ...
      <p className="mb-4">
        Naast mijn interesse voor coderen en eten, kan ik 
      ...
      <p>
        ...
        aan de slag ga met het maken van websites. De komende tijd ga ik 
        daar verder mee pionieren. 
      </p>
    </div>
  );
}
