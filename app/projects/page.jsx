      ...
      <div>
        <div>
          ...
          <div>
            <p className="text-beigelight my-8">
              Deze website voor mijn praktijk SMART Voedingsadvies heb ik
              gemaakt na het voltooien van de opleiding. Ik heb de website
              gemaakt met {" "}<a href="https://wordpress.com/nl/" className="text-purplelight hover:text-beigelight" target="blank">
                WordPress
              </a>
              {" "}en{" "}
              <a href="https://elementor.com/" className="text-purplelight hover:text-beigelight" target="blank">
                Elementor
              </a>
              . Als basis heb ik voor het{" "}
              <a href="https://creativethemes.com/blocksy/" className="text-purplelight hover:text-beigelight" target="blank">
                Blocksy-Theme
              </a>{" "}
              gekozen. Daarbij heb ik geen standaard templates gebruikt, maar
              zelf de pagina`s opgebouwd. Waar nodig heb ik CSS naar eigen wens
              aangepast.
            </p>
          </div>
        </div>
        ...
        <div>
          <p className="text-beigelight my-8">
            ...
            <a href="https://vite.dev/" className="text-purplelight hover:text-beigelight" target="blank">
              Vite.js
            </a>
            ,{" "}
            <a href="https://reactrouter.com/" className="text-purplelight hover:text-beigelight" target="blank">
              React Router</a> en{" "}
              <a href="https://www.chakra-ui.com/" className="text-purplelight hover:text-beigelight" target="blank">Chakra UI
            </a>
            ...
            <a href="https://my-json-server.typicode.com/" className="text-purplelight hover:text-beigelight" target="blank">
              My JSON Server
            </a>
            .
          </p>
      ...
      <div>
        ...
        <div>
          <p className="text-beigelight my-8">
            ...
            applicatie is gemaakt met behulp van{" "}
            <a href="https://react.dev/" className="text-purplelight hover:text-beigelight" target="blank">
              React</a> en {" "}
              <a href="https://www.chakra-ui.com/" className="text-purplelight hover:text-beigelight" target="blank">Chakra UI
            </a>
